...
# -*- coding: utf-8 -*-
#
# html_edit documentation build configuration file
#
...
project = 'html_edit'
copyright = '2021, Jeremy Alcanzare'
...
_version_py = os.path.join(repo, 'html_edit', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'html_editdoc'
...
latex_documents = [
    (master_doc, 'html_edit.tex', 'html_edit Documentation',
     'Jeremy Alcanzare', 'manual'),
]
